...
`plot_beta1_ma()` visualizes inferred guide effects against average abundance, highlighting guides with strong positive or negative effects relative to their baseline counts.

```{r}
plot_beta1_ma(biscuit_fit)
```
