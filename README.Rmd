...
We provide full tutorial that demonstrates how to use `biscuit` with an example data set, in the introductory (vignette)[[https://github.com/sandyskim/biscuit/blob/main/vignettes/introduction.Rmd](https://github.com/sandyskim/bbiscuit/blob/main/vignettes/introduction.Rmd){.uri}].
